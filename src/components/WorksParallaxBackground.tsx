...
interface WorksParallaxBackgroundProps {
  scrollTargetRef: RefObject<HTMLElement | null>;
}

const WorksParallaxBackground = ({ scrollTargetRef }: WorksParallaxBackgroundProps) => {
  ...
  return (
    <div className="works-parallax" aria-hidden="true">
      <motion.div
...
export default WorksParallaxBackground;
